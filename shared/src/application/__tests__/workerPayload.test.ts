...
import { computeDetForWorker, mapGenderForWorker, mapSampleTypeForWorker } from "../workerPayload";

describe("worker payload helpers", () => {
  ...
  it("computes DET payload as strings", () => {
    expect(computeDetForWorker("28.4", "26.1", "27.5", "24.0")).toEqual({
