...
export class RecordController {
    ...
    try {
      ...
      if (input.evaluationAsync) {
        ...
        record = {
          ...
          uploadId: recordDraft.uploadId,
          slideFileName: recordDraft.slideFileName,
          slideId: recordDraft.slideId,
          samplingDate: recordDraft.samplingDate,
          receptionDate: recordDraft.receptionDate,
          testDate: recordDraft.testDate,
          modelType: recordDraft.modelType,
          generateHeatmap: recordDraft.generateHeatmap,
  ...
  async batchEnqueueEvaluationJobs(
    ...
    const recordDrafts = input.records.map((r) => ({
      ...
      uploadId: r.uploadId,
      slideFileName: r.slideFileName,
      slideId: r.slideId,
      samplingDate: r.samplingDate,
      receptionDate: r.receptionDate,
      testDate: r.testDate,
      modelType: r.modelType,
      generateHeatmap: r.generateHeatmap,
